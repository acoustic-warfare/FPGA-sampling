...
set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33     } [get_ports { sck_clk1 }]; #IO_L13P_T2_MRCC_13 Sch=jb_p[3]                  #ws0
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33     } [get_ports { ws1 }]; #IO_L13N_T2_MRCC_13 Sch=jb_n[3]                       #sck_clk0
set_property -dict { PACKAGE_PIN V6    IOSTANDARD LVCMOS33     } [get_ports { sck_clk0 }]; #IO_L22P_T3_13 Sch=jb_p[4]             
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33     } [get_ports { ws0 }]; #IO_L22N_T3_13 Sch=jb_n[4]             
