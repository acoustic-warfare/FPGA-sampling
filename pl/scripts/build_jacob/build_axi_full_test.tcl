...
# Set the file that will be top module              # my top file instead
set top_module [file join "$ROOT" src wrappers aw_top_3.vhd]    

add_files [file join "$ROOT" src wrappers aw_top_3.vhd]
...
add_files [file join "$ROOT" src sample_data fifo_3.vhd]
...
#source [ file normalize [ file join $ROOT scripts build_jacob jacob_bd.tcl ] ]
...
# Make wrapper jacob_bd
#make_wrapper -inst_template [ get_files {jacob_bd.bd} ]
#add_files -files [file join "$ROOT" vivado_files acoustic_warfare.srcs sources_1 bd jacob_bd hdl jacob_bd_wrapper.vhd]
