...
proc create_root_design { parentCell } {
   ...
   set axi_header [ create_bd_port -dir I -from 31 -to 0 axi_header ]
   ...
   # Create instance: axi_v1_0_0, and set properties
   ...
   connect_bd_intf_net -intf_net axi_v1_0_0_m00_axi [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins axi_v1_0_0/m00_axi]
   connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
   connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
   connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
   connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins axi_v1_0_0/s00_axi] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

   # Create port connections
   connect_bd_net -net axi_v1_0_0_rd_en  [get_bd_pins axi_v1_0_0/rd_en] \
      [get_bd_ports axi_rd_en]
   ...
   connect_bd_net -net clk_wiz_0_clk_125  [get_bd_pins clk_wiz_0/clk_125] \
      [get_bd_ports clk_125] \
      [get_bd_pins axi_smc/aclk] \
      [get_bd_pins axi_v1_0_0/m00_axi_aclk] \
      [get_bd_pins axi_v1_0_0/s00_axi_aclk] \
      ...
      [get_bd_pins rst_ps7_0_50M_1/slowest_sync_clk]
   connect_bd_net -net data_0_1  [get_bd_ports axi_data] \
      [get_bd_pins axi_v1_0_0/data]
   connect_bd_net -net empty_0_1  [get_bd_ports axi_empty] \
      [get_bd_pins axi_v1_0_0/empty]
   connect_bd_net -net header_0_1  [get_bd_ports axi_header] \
      [get_bd_pins axi_v1_0_0/header]
   connect_bd_net -net nr_arrays_0_1  [get_bd_ports axi_nr_arrays] \
      [get_bd_pins axi_v1_0_0/nr_arrays]
   connect_bd_net -net processing_system7_0_FCLK_RESET0_N  [get_bd_pins processing_system7_0/FCLK_RESET0_N] \
      [get_bd_pins rst_ps7_0_50M/ext_reset_in] \
      [get_bd_pins rst_ps7_0_50M_1/ext_reset_in]
   connect_bd_net -net rst_ps7_0_50M_1_peripheral_aresetn  [get_bd_pins rst_ps7_0_50M_1/peripheral_aresetn] \
      [get_bd_pins axi_v1_0_0/m00_axi_aresetn]
   ...
   connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn  [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] \
      ...
      [get_bd_pins axi_v1_0_0/s00_axi_aresetn] \
      [get_bd_pins ps7_0_axi_periph/M00_ARESETN] \
      [get_bd_pins ps7_0_axi_periph/S00_ARESETN]
   connect_bd_net -net sys_id_0_1  [get_bd_ports axi_sys_id] \
      [get_bd_pins axi_v1_0_0/sys_id]
