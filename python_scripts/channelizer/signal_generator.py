...
def generate_signal(long_tone=True, shot_tone=True, chirp=True, noise=True, plt=True):
    ...
    input_signal = _normalize(input_signal, max_amplitude)
    sig_no_noise = _normalize(sig_no_noise, max_amplitude)
...
def _normalize(input_signal, max_amplitude):
