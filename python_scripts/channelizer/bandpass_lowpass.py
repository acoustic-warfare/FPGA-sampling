...
# Low pass parameters
num_taps_low_pass = 128  # Number of taps per filter
...
def apply_lowpass_filters(subband_signals, center_frequencies):
    ...
    for i, center_frequency in enumerate(center_frequencies):
        ...
        subband_signals_low_pass.append(lowpass_filterd_signal)

    return np.array(subband_signals_low_pass)
...
subband_signals_low_pass = apply_lowpass_filters(subband_signals, center_frequencies)

downsampled_subbands = apply_down_sampling(subband_signals_low_pass)
