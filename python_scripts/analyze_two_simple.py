...
def load_data_FPGA(fileChooser):
    ROOT = os.getcwd()
    path = Path(ROOT + "/recorded_data/v22_3/" + fileChooser + ".bin")
...
plt.tight_layout()
plt.savefig(f"./recorded_data/v22_3/images/spectrogram_compare_{file1}_vs_{file2}.png")
plt.savefig(f"./recorded_data/v22_3/images/spectrogram_compare_{file1}_vs_{file2}.pdf")
...
plt.grid(True)
plt.tight_layout()
plt.savefig(f"./recorded_data/v22_3/images/avg_freq_response_{file1}_vs_{file2}.png")
plt.savefig(f"./recorded_data/v22_3/images/avg_freq_response_{file1}_vs_{file2}.pdf")
