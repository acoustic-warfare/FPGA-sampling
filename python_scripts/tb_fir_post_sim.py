...
plt.subplot(5, 1, 3)
plt.plot(selected_frequencies,
         smoothed_input_fft[indices], label="Smoothed FFT of Input Samples")
...
plt.subplot(5, 1, 4)
plt.plot(selected_frequencies,
         smoothed_output_fft[indices], label="Smoothed FFT of Output Samples", color="orange")
