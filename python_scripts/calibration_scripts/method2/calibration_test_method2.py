...
def collect_samples(filename, recordTime):
    ...
    class Data(Structure):
        _fields_ = [
            ...
            ("mic_1", c_int32), ("mic_2", c_int32), ("mic_3", c_int32), ("mic_4", c_int32), ("mic_5", c_int32), ("mic_6", c_int32), ("mic_7", c_int32), ("mic_8", c_int32), ("mic_9", c_int32), ("mic_10", c_int32), ("mic_11", c_int32), ("mic_12", c_int32), ("mic_13", c_int32), ("mic_14", c_int32), ("mic_15", c_int32), ("mic_16", c_int32), ("mic_17", c_int32), ("mic_18", c_int32), ("mic_19", c_int32), ("mic_20", c_int32), ("mic_21", c_int32), ("mic_22", c_int32), ("mic_23", c_int32), ("mic_24", c_int32), ("mic_25", c_int32), ("mic_26", c_int32), ("mic_27", c_int32), ("mic_28", c_int32), ("mic_29", c_int32), ("mic_30", c_int32), ("mic_31", c_int32), ("mic_32", c_int32), ("mic_33", c_int32), ("mic_34", c_int32), ("mic_35", c_int32), ("mic_36", c_int32), ("mic_37", c_int32), ("mic_38", c_int32), ("mic_39", c_int32), ("mic_40", c_int32), ("mic_41", c_int32), ("mic_42", c_int32), ("mic_43", c_int32), ("mic_44", c_int32), ("mic_45", c_int32), ("mic_46", c_int32), ("mic_47", c_int32), ("mic_48", c_int32), ("mic_49", c_int32), ("mic_50", c_int32), ("mic_51", c_int32), ("mic_52", c_int32), ("mic_53", c_int32), ("mic_54", c_int32), ("mic_55", c_int32), ("mic_56", c_int32), ("mic_57", c_int32), ("mic_58", c_int32), ("mic_59", c_int32), ("mic_60", c_int32), ("mic_61", c_int32), ("mic_62", c_int32), ("mic_63", c_int32), ("mic_64", c_int32),
        ]
    UDP_IP = "0.0.0.0"
    UDP_PORT = 21844
...
if __name__ == '__main__':
    ...
    plt.subplot(2, 1, 1)
    plt.plot(freqs[:fft_size//2], 20 * np.log(np.abs(ref_mic_FR))
             [:fft_size//2], label="Frequency response reference MK5", color='green')
    plt.xlabel('Frequency (Hz)')
    plt.ylabel('Magnitude (dB)')
    plt.legend(loc='lower left')

    plt.subplot(2, 1, 1)
    plt.plot(freqs[:fft_size//2], 20 * np.log(np.abs(other_mic_FR))
             [:fft_size//2], label="Frequency response MK16", color='orange')
    plt.xlabel('Frequency (Hz)')
    ...
    plt.subplot(2, 1, 2)
    plt.plot(freqs[:fft_size//2], 20 * np.log(np.abs(other_mic_deviation))
    ...
    # plt.subplot(3,1,3)
    plt.plot(freqs[:fft_size//2], 20 * np.log(np.abs(deviation_after_calibration))
             [:fft_size//2], label="Deviation after", color='red')
    plt.xlabel('Frequency (Hz)')
    plt.ylabel('Magnitude')
    plt.legend(loc='lower left')
    plt.show()
    ...
    plt.subplot(3, 1, 3)
    plt.plot(other_mic_calibrated, color='blue',
             label='MK16 after calibration')
    plt.xlabel('Samples')
    plt.ylabel('Amplitude')
    plt.legend(loc='lower left')
    plt.show()
