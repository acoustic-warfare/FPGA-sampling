...
alias build_simulated_sampling='vivado -notrace -mode batch -source $(git rev-parse --show-toplevel)/pl/scripts/build_simulated_array/build_simulated_array.tcl'
